...
export const ACID_SPRAY_RANGE = 17.5;
export const ACID_SPRAY_COOLDOWN_SECONDS = 1.65;
export const ACID_SPRAY_DURATION_SECONDS = 0.48;
export const ACID_DEBUFF_SECONDS = 3.8;
export const ACID_DEBUFF_MAX = 1.8;
