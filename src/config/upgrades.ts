...
export const UPGRADE_DEFS: UpgradeDef[] = [
  ...
  },
  {
    ...
    effect: "土木アリの育成枠を2匹ずつ増やし、土木工事を解禁する",
    max: 5,
    baseCost: 150,
    costScale: 1.75,
  ...
  },
  {
    ...
    effect: "敵の侵入と突破圧を遅らせる兵隊の育成枠を増やす",
    max: 4,
    baseCost: 245,
    costScale: 1.92,
    requires: { ants: 24, nestLevel: 2, upgrades: { soldierTraining: 1 } },
