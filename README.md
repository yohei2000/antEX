...
- ピンチ: ズーム
- 成長タブ: 巣と資源の状態確認、強化購入
- 土木タブ: 土木アリの状態確認、採餌道整備、低い土塁の発注、作業ごとの担当数調整
...
土木アリも平時は巣内リソースとして扱い、土木タブから工事に割り当てられた時だけ地表へ出ます。各工事は開始時1匹担当で、作業ごとに1〜10匹の範囲で増減できます。土木工事は完全な地形変形ではなく、軽量な範囲効果と視覚表現として扱います。
