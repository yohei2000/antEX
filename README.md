...
1. 働きアリが食料を集める
2. 兵舎タブで働きアリ、土木アリ、兵隊アリを育成キューへ入れる
...
- 兵舎タブ: 働きアリ、土木アリ、兵種ごとの食料コストと育成時間を見て、育成キューへ追加
- 兵隊タブ: 巣内兵隊の確認、兵隊出撃

通常アプリから遠征モードは削除済みです。働きアリ、土木アリ、兵隊アリ、特殊兵はすべて兵舎タブの育成キューで1匹ずつ増えます。兵隊アリは平時は巣内リソースとして扱い、プレイヤーが兵隊タブから指示した時だけ地表へ出撃します。
