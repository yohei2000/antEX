...
const LATE_BASE = {
  ...
  variants: { heavySoldierAnts: 4, shieldHeadAnts: 4, acidShooterAnts: 4, scoutAnts: 4, captainAnts: 3 },
};
...
const SCENARIOS = [
  ...
  },
  {
    ...
    config: {
      ...
      variants: { heavySoldierAnts: 1, shieldHeadAnts: 1, acidShooterAnts: 1, scoutAnts: 1, captainAnts: 1 },
    },
  },
  ...["heavySoldier", "shieldHead", "acidShooter", "scout", "captain", "soldier"].map((variant) => ({
